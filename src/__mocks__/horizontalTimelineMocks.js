...
const itemsMock = [
  {
    ...
    icon: 'hospital',
    id: 'procedure1',
    start_time: 1534871748289,
    title: 'Documentation of current medications'
  },
  {
    className: 'timeline-item theme-dark', 
    end_time: 1254666855000,
    group: 1,
