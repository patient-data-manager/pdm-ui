...
export const PROVIDE_OAUTH_TOKEN = 'PROVIDE_OAUTH_TOKEN';
export const PROVIDE_OAUTH_TOKEN_FULFILLED = 'PROVIDE_OAUTH_TOKEN_FULFILLED';

// ------------------------- HEALTH RECORDS -------------------------------- //
export const FETCH_PATIENT_EVERYTHING = "FETCH_PATIENT_EVERYTHING";
export const FETCH_PATIENT_EVERYTHING_SUCCESS = "FETCH_PATIENT_EVERYTHING_SUCCESS";
export const FETCH_PATIENT_EVERYTHING_FAILURE = "FETCH_PATIENT_EVERYTHING_FAILURE";
